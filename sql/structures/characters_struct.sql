...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 07. Feb 2014 um 01:44
...
-- Prozeduren
--
CREATE DEFINER=`sql_woofwo_tbc`@`127.0.0.1` PROCEDURE `PreventCharDelete`(IN charguid INT UNSIGNED)
BEGIN
...
--
-- Tabellenstruktur für Tabelle `arena_team_push`
--

CREATE TABLE IF NOT EXISTS `arena_team_push` (
...
--
-- Tabellenstruktur für Tabelle `auctionhousebot`
--
...
--
-- Tabellenstruktur für Tabelle `character_bgcoord`
--

CREATE TABLE IF NOT EXISTS `character_bgcoord` (
  `guid` int(11) unsigned NOT NULL DEFAULT '0' COMMENT 'Global Unique Identifier',
...
--
-- Tabellenstruktur für Tabelle `character_push`
--

CREATE TABLE IF NOT EXISTS `character_push` (
...
--
-- Tabellenstruktur für Tabelle `character_quest`
--
...
--
-- Tabellenstruktur für Tabelle `character_stats_ro`
--

CREATE TABLE IF NOT EXISTS `character_stats_ro` (
...
--
-- Tabellenstruktur für Tabelle `character_stop_level`
--

CREATE TABLE IF NOT EXISTS `character_stop_level` (
...
CREATE TABLE IF NOT EXISTS `character_tutorial` (
  ...
  KEY `account` (`account`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Player System' AUTO_INCREMENT=1642 ;
...
--
-- Tabellenstruktur für Tabelle `characters_backup`
--
...
--
-- Tabellenstruktur für Tabelle `deleted_chars`
--

CREATE TABLE IF NOT EXISTS `deleted_chars` (
...
--
-- Tabellenstruktur für Tabelle `game_event_condition_save`
--
...
--
-- Tabellenstruktur für Tabelle `game_event_save`
--
...
--
-- Tabellenstruktur für Tabelle `gm_tickets`
--
...
--
-- Tabellenstruktur für Tabelle `group_saved_loot`
--

CREATE TABLE IF NOT EXISTS `group_saved_loot` (
...
--
-- Tabellenstruktur für Tabelle `guild_announce_cooldown`
--
...
--
-- Tabellenstruktur für Tabelle `hidden_rating`
--
...
--
-- Tabellenstruktur für Tabelle `item_template`
--
...
--
-- Tabellenstruktur für Tabelle `mail_external`
--
...
--
-- Tabellenstruktur für Tabelle `map_template`
--
...
--
-- Tabellenstruktur für Tabelle `opcodes_cooldown`
--

CREATE TABLE IF NOT EXISTS `opcodes_cooldown` (
...
--
-- Tabellenstruktur für Tabelle `reserved_name`
--
...
--
-- Tabellenstruktur für Tabelle `spell_disabled`
--
